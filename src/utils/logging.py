...
class RunLogger:
    ...
    def __init__(self, run_id: Optional[str] = None):
        ...
        self.log_data = {
            "RunId": self.run_id,
            "SimulationConfiguration": {"_description": "Simulation configuration used to generate the data"},
            "RuntimeEnvironment": {
                "_description": "Runtime environment information",
                "Host": {
                    "Hostname": None,
                    "OS": None,
                    "Kernel": None,
            ...
            "Code": { 
                "_description": "Code repository information; TO-DO: split into neuromotion vs muniverse?",
                "Repository": None,
                "URL": None,
                "Branch": None,
                "Commit": None,
            ...
            "Execution": {
                "_description": "Execution timing and return codes",
                "Timing": {
            ...
            "Outputs": {
                "_description": "Output files generated by the run and their metadata",
                "Files": [],
                "Metadata": {}
            }
        }
    ...
    def set_config(self, config_content: Dict[str, Any]):
        ...
        """
        self.log_data["SimulationConfiguration"] = config_content
